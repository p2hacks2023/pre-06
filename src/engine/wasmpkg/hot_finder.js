...
export function evaluate_hotness_mock(test_value) {
    const ptr0 = passStringToWasm0(test_value, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
export function extract_hot_buffer_mock(img) {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(img, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {number}
*/
export function evaluate_hotness(_img) {
    const ptr0 = passStringToWasm0(_img, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
